...
// import { AbstractConference, type AbstractProps, abstractMapStateToProps } from "../AbstractConference";
...
// import CustomToolbar from "../../../toolbox/components/native/CustomToolbar";
...
//             this.setState({ showBootBlack: true });

//             setTimeout(() => {
//                 navigate(screen.conference.carmode);

//                 setTimeout(() => {
//                     this.setState({ showBootBlack: false });
//                 }, 1000);
//             }, 300);
//         }
//     }
...
//      */
//     // override render() {
//     //     const { _brandingStyles } = this.props;
...
//                 {/* ✅ BLACK SCREEN OVERLAY (NO FLICKER) */}
//                 {this.state.showBootBlack && (
//                     <View
//                         style={{
//                             position: "absolute",
//                             top: 0,
...
//                     style={
//                         // _toolboxVisible?
//                         styles.titleBarSafeViewColor as ViewStyle // : styles.titleBarSafeViewTransparent
//                     }
//                 >
...
class Conference extends AbstractConference<IProps, State> {
        ...
        if (_forceCarMode && !_isModerator) {
            ...
            setTimeout(() => {
                this.props.navigation.reset({
                    index: 0,
                    routes: [{ name: screen.conference.carmode }],
                });
    ...
    _renderContent() {
        ...
        if (this.props._forceCarMode && !this.props._isModerator) {
            return null;
        }
            ...
            <>
                {
                    ...
                    // _shouldDisplayTileView ? (
                    // <TileView onClick={this._onClick} />
                    <TileView onClick={this.props._forceCarMode ? undefined : this._onClick} />
                    // ) : (
                    //     <LargeVideo onClick={this._onClick} />
                    // )
                }
                ...
                {!this.props._forceCarMode && (
                    <SafeAreaView pointerEvents="box-none" style={styles.titleBarSafeViewColor as ViewStyle}>
                        <TitleBar _createOnPress={this._createOnPress} />
                    </SafeAreaView>
                )}
