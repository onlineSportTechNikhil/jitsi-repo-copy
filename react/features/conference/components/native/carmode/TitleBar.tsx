...
const TitleBar = (props: IProps): JSX.Element => {
    ...
    const displayName = props._meetingName ? `${props._meetingName.split(" ")[0]}` : "";

    return (
        <View style={styles.titleBarWrapper as StyleProp<ViewStyle>}>
            <View pointerEvents="box-none" style={styles.roomNameWrapper as StyleProp<ViewStyle>}>
                {/* <View style={styles.qualityLabelContainer as StyleProp<ViewStyle>}>
                    <VideoQualityLabel />
                </View> */}
                {/* <ConnectionIndicator iconStyle={styles.connectionIndicatorIcon} participantId={localParticipantId} /> */}
