...
import BreakoutRooms from "../../../../../breakout-rooms/components/native/BreakoutRooms"; // @ts-ignore
// @ts-ignore
...
import AddPeopleDialog from "../../../../../invite/components/add-people-dialog/native/AddPeopleDialog"; // @ts-ignore
// @ts-ignore
...
import StartRecordingDialog from "../../../../../recording/components/Recording/native/StartRecordingDialog"; // @ts-ignore
import SalesforceLinkDialog from "../../../../../salesforce/components/native/SalesforceLinkDialog"; // @ts-ignore
import SecurityDialog from "../../../../../security/components/security-dialog/native/SecurityDialog"; // @ts-ignore
import SpeakerStats from "../../../../../speaker-stats/components/native/SpeakerStats"; // @ts-ignore
import LanguageSelectorDialog from "../../../../../subtitles/components/native/LanguageSelectorDialog"; // @ts-ignore
...
const ConferenceNavigationContainer = () => {
    ...
    return (
        <NavigationContainer independent={true} ref={conferenceNavigationRef} theme={navigationContainerTheme as Theme}>
